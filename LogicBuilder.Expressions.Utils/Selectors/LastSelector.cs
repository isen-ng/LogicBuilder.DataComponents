...
{
    public class LastSelector : SelectorBase
    {
        public override SelectorTypeEnum SelectorTypeEnum => SelectorTypeEnum.Last;
        ...
        public override Expression GetExpression(Expression parentExpression, Dictionary<string, ParameterExpression> parentParameters)
            => FilterGroup == null
                ? parentExpression.GetLast()
                : parentExpression.GetLast(FilterGroup, GetSelectorParameterName());
    }
}
